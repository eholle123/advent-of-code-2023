...
if __name__ == "__main__":
    # lines = read_input(Path("inputs/inputs/part2/test_input_4_tiles_in_loop.txt"))
    # lines = read_input(Path("inputs/inputs/part2/test_input_8_tiles_in_loop.txt"))
    # lines = read_input(Path("inputs/inputs/part2/test_input_10_tiles_in_loop.txt"))

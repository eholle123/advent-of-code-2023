...
def get_how_many_steps_taken(start_node: str, end_node: str, network: Dict[str, Tuple[str,str]], directions: List[str], steps_taken: int) -> int:
    ...
    if next_node != end_node:
        ...
        steps_taken = get_how_many_steps_taken(next_node, end_node, network, directions, steps_taken)
    return steps_taken
